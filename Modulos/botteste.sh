...
[[ $(screen -list| grep -c 'bot_teste') == '0' ]] && {
    clear
    echo -e "\\E[44;1;37m     ACTIVATION BOT SSH TEST / SSH စမ်းသပ် ဘော့ အသက်သွင်းခြင်း     \\E[0m"
    echo ""
    ...
    wget https://github.com/NaokiKun/NAOKI-SSH/raw/main/Sistema/botssh >/dev/null 2>&1
    chmod 777 botssh
    echo ""
    sleep 1
