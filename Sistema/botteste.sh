...
[[ $(screen -list| grep -c 'bot_teste') == '0' ]] && {
    clear
    echo -e "\E[44;1;37m     SSH TEST BOT ACTIVATION / SSH စမ်းသပ်ဘော့ ဖွင့်ခြင်း     \E[0m"
    echo ""
    ...
    wget https://raw.githubusercontent.com/NaokiKun/NAOKI-SSH/main/Sistema/botssh >/dev/null 2>&1
    chmod 777 botssh
    echo ""
    sleep 1
